...
class ModulatedDeformConv(nn.Module):
    ...
    def forward(self, input, offset_mask):
        o1, o2, mask = torch.chunk(offset_mask, 3, dim=1)
        offset = torch.cat((o1, o2), dim=1)
        mask = torch.sigmoid(mask)
        # print(2 * self.deformable_groups * self.kernel_size[0] * self.kernel_size[1])
        # print(self.deformable_groups * self.kernel_size[0] * self.kernel_size[1])
